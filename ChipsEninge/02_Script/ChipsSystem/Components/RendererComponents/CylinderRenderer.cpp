...
{
	CylinderRenderer::CylinderRenderer() : AMeshRenderer("CylinderRenderer")
	{
	}

	VOID CylinderRenderer::InitGemometryBuffer()
	{
		m_isLoaded = true;
		MeshData meshData;
		MeshGenerator::CreateCylinder(0.5f, 0.5f, 1.0f, 15, 5, meshData);
